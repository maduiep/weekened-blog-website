...
export default function AdminSidebar({ activeTab, setActiveTab, contactMessages, adminRecords, paymentReceipts, adminUsersCount }) {
  return (
    ...
    >
          <div className="admin-sidebar-header" style={{ marginTop: 0, marginBottom: "var(--space-md)", padding: "0 var(--space-sm)" }}>
          ...
          <nav style={{ display: "flex", flexDirection: "column", gap: "6px" }}>
            {[
              ...
              { id: "newsletters", label: "Newsletters", icon: Mail, badge: JSON.parse(localStorage.getItem("wp_newsletter_subs") || "[]").length },
