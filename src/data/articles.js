export const defaultArticles = [
  {
    ...
    excerpt:
      "While global oil prices have fallen to multi-month lows, analysts warn that underlying supply constraints could trigger a sharp reversal in the months ahead, with potential ripple effects across Botswana's economy.",
    category: "business",
    author: "Aubrey Lute",
    date: "April 22, 2026",
    readTime: "5 min read",
  ...
  },
  {
    ...
    excerpt:
      "The Bank of Botswana's latest financial stability report reveals a concerning trend as non-performing loans across the banking sector have climbed to unprecedented levels.",
    category: "business",
  ...
  },
  {
    ...
    excerpt:
      "International financial institutions have revised their growth projections for Botswana downward, citing continued weakness in the global diamond market as a primary drag on the economy.",
    category: "business",
    author: "Admin",
    date: "April 21, 2026",
    readTime: "7 min read",
  ...
  },
  {
    ...
    excerpt:
      "The Botswana Council of Non-Governmental Organisations has raised several red flags about proposed legislation to establish a Constitutional Court, warning that certain provisions could undermine judicial independence.",
    category: "news",
  ...
  },
  {
    ...
    excerpt:
      "The annual Absa-sponsored children's marathon drew record participation this weekend, with over 2,000 young athletes taking to the streets of Gaborone in a colourful display of youth empowerment.",
    category: "sport",
    author: "Kenneth Mosekiemang",
    date: "April 21, 2026",
    readTime: "3 min read",
  ...
  },
  {
    ...
    excerpt:
      "The Botswana Football Association has unveiled an ambitious strategic plan aimed at transforming the sport in the country, with a target of qualifying for the FIFA World Cup by 2036.",
    category: "sport",
    author: "Sports Desk",
    date: "April 20, 2026",
    readTime: "8 min read",
  ...
  },
  {
    ...
    excerpt:
      "A member of the Botswana national football team was reportedly deported from a Southern African country after authorities questioned the authenticity of travel documents.",
    category: "sport",
    author: "Staff Reporter",
    date: "April 20, 2026",
    readTime: "3 min read",
  ...
  },
  {
    ...
    excerpt:
      "The landmark agreement between Washington and Tehran is expected to have far-reaching implications for global commodity markets, with particular relevance for resource-dependent economies.",
    category: "business",
    author: "Admin",
    date: "April 20, 2026",
    readTime: "6 min read",
  ...
  },
  {
    ...
    excerpt:
      "Former intelligence chief Isaac Kgosi's associate has filed a constitutional challenge against the legal proceedings, arguing that the charges violate fundamental rights protections.",
    category: "news",
  ...
  },
  {
    ...
    title: "A PEP TALK",
    excerpt:
      "In this week's column, our resident commentator explores the delicate balance between political ambition and public accountability in Botswana's evolving democratic landscape.",
    category: "opinion",
    author: "Admin",
    date: "April 19, 2026",
    readTime: "4 min read",
  ...
  },
  {
    ...
    excerpt:
      "As global markets shift, moving away from diamond reliance to a true knowledge-based economy is more critical than ever. Here is a blueprint for the next decade.",
    category: "opinion",
  ...
  },
  {
    ...
    excerpt:
      "Promises of new stadiums and world-class training facilities remain unfulfilled as local athletes struggle to prepare for international competitions.",
    category: "opinion",
  ...
  },
  {
    ...
    excerpt:
      "The government's flagship employment initiative has officially begun, but questions remain about when participants will receive their first payments.",
    category: "news",
    author: "Staff Reporter",
    date: "April 19, 2026",
    readTime: "4 min read",
  ...
  },
  {
    ...
    excerpt:
      "A powerful new documentary series examining the life, controversies, and legacy of Winnie Madikizela-Mandela has premiered on Netflix to critical acclaim.",
    category: "lifestyle",
...
export const categories = [
  ...
  },
  {
    slug: "lifestyle",
    name: "Weekend Life",
    color: "var(--color-lifestyle-pink)",
...
export const ePapers = [
  ...
  {
    id: 3,
    title: "04 April 2026 Publication",
    date: "April 4, 2026",
    latest: false,
    image: "/images/epaper.png",
  },
  {
    id: 4,
    title: "28 March 2026 Publication",
    date: "March 28, 2026",
    latest: false,
    image: "/images/epaper.png",
  },
  {
    id: 5,
    title: "21 March 2026 Publication",
    date: "March 21, 2026",
    latest: false,
    image: "/images/epaper.png",
  },
  {
    id: 6,
    title: "14 March 2026 Publication",
    date: "March 14, 2026",
    latest: false,
    image: "/images/epaper.png",
  },
  {
    id: 7,
    title: "07 March 2026 Publication",
    date: "March 7, 2026",
    latest: false,
    image: "/images/epaper.png",
  },
  {
    id: 8,
    title: "28 February 2026 Publication",
...
export const subscriptionPlans = [
  {
    ...
    popular: false,
    features: [
      "Purchase access to one premium article",
      "No subscription commitment",
      "Secure single-article access",
  ...
  },
  {
    ...
    popular: false,
    features: [
      "Access to weekly e-paper editions",
      "Unlimited reading for the week",
      "Discounted price per story",
      "Works with all payment gateways",
    ],
  },
  {
    ...
    popular: true,
    features: [
      "Access to all e-paper editions for a month",
  ...
  },
  {
    ...
    popular: false,
    features: [
      "Full year access to all e-paper editions",
...
export const paymentMethods = [
  ...
  },
  {
    ...
    icon: '🏦',
    color: '#DC0032',
    description: 'Pay via Absa secure merchant gateway',
    instructions: 'You will be redirected to Absa secure payment portal',
    type: 'redirect',
    active: true,
  },
  {
