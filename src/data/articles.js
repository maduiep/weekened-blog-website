...
export const subscriptionPlans = [
  ...
  },
  {
    ...
    popular: false,
    features: [
      "Team access for business users",
      "Enterprise analytics dashboard",
      "Dedicated support & onboarding",
      "Custom e-paper delivery",
      "API-ready integration hooks for CRM and CMS",
    ],
  },
  {
    id: "enterprise",
    ...
    popular: false,
    features: [
      "Unlimited seats and enterprise licensing",
      "VIP customer success manager",
      "Custom data feeds and integration APIs",
      "Future-ready newsroom and system integrations",
      "White-label and brand-safe distribution",
    ],
  },
];
